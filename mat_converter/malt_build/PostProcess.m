...
%% Load data
sys_output = load('3_18_26\malt1_4_PID.mat');
...
ylabel('Yaw');
% subplot(6,1,5);
% plot(t, sys_output.vms_aux4(idx)); grid on;
% ylabel('Arm'); xlabel('Time [s]');
% subplot(6,1,6);
% plot(t, sys_output.vms_aux5(idx)); grid on;
...
subplot(4,1,1);
plot(t, sys_output.vms_aux6(idx)); grid on;
