% Configures the simulation for the Ultra Stick 25e aircraft
% Based on data from the University of Minnesota UAV Lab:
% https://www.uav.aem.umn.edu/
%
% Brian R Taylor
